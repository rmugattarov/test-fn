...
public class TestObjectReference {
    ...
    public void test() {
        ...
        try {
            ...
            Folder folder = Factory.Folder.fetchInstance(objectStore, "/test/rmugattarov/test-object-reference", null);
            Document document = Factory.Document.createInstance(objectStore, "KatStroy", null);
            document.checkin(AutoClassify.DO_NOT_AUTO_CLASSIFY, CheckinType.MAJOR_VERSION);
            Document parent = Factory.Document.fetchInstance(objectStore, "{109CE754-0000-CD16-A27A-12C105284E3C}", null);
            document.getProperties().putObjectValue("ParentCatalogItem", parent.getObjectReference());
